...
public let _dyld_get_image_uuid = unsafeBitCast(dlsym(dlopen(nil, RTLD_LAZY), "_dyld_get_image_uuid"), to: (@convention(c) (UnsafePointer<mach_header>, UnsafeRawPointer) -> Bool)?.self)!
public let dyld_image_path_containing_address = unsafeBitCast(dlsym(dlopen(nil, RTLD_LAZY), "dyld_image_path_containing_address"), to: (@convention(c) (UnsafeRawPointer) -> UnsafePointer<CChar>?)?.self)!
